                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="row">
                            <div class="col-md-12 ">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Gejala <small>List</small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="tooltip-test" title="Tambah" href="<?php echo site_url('admin/gejala/add') ?>"><i class="fa fa-plus"></i></a></li>
                                            <li><a class="collapse-link tooltip-test" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li><a class="tooltip-test" title="Help" data-toggle="modal" data-target="#gejalaHelp"><i class="fa fa-question"></i></a>
                                            </li>
                                        </ul>
                                        <div class="clearfix"></div>
                                    </div>
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo site_url('admin/gejala/edit/'.$data['id']) ?>"
                                                                    class="btn btn-small"><i class="fa fa-edit"></i> Edit</a>
											                        <a onclick="deleteConfirm('<?php echo site_url('admin/gejala/delete/'.$data['id']) ?>')"
