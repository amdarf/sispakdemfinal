                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="row">
                            <div class="col-md-12 ">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Penyakit <small>List</small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="tooltip-test" title="Tambah" href="<?php echo site_url('admin/penyakit/add') ?>"><i class="fa fa-plus"></i></a></li>
                                            <li><a class="collapse-link tooltip-test" title="Collapse"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                            <li><a class="tooltip-test" title="Help" data-toggle="modal" data-target="#penyakitHelp"><i class="fa fa-question"></i></a>
                                            </li>
                                        </ul>
                                        <div class="clearfix"></div>
                                    </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <ul>
                                                                        <?php
                                                                            for($i=0; $i<count($data['gejala_penyakit']); $i++){
                                                                                foreach($gejala as $gj){
                                                                                    if($gj['id']==$data['gejala_penyakit'][$i]){
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo site_url('admin/penyakit/edit/'.$data['id']) ?>"
                                                                    class="btn btn-small"><i class="fa fa-edit"></i> Edit</a>
											                        <a onclick="deleteConfirm('<?php echo site_url('admin/penyakit/delete/'.$data['id']) ?>')"
