                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form class="form-horizontal form-label-left" action="<?php echo site_url('admin/penyakit/edit/'.$penyakit['id']) ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-9 col-sm-9 form-group has-feedback">
                                                    ...
                                                    type="text" placeholder="Nama Penyakit" name="penyakit" value="<?= $penyakit['penyakit'] ?>" required>
                                            ...
                                            <div id="dynamicInputContainer">
                                                <?php $id = 0; ?>
                                                <?php foreach($penyakit['gejala_penyakit'] as $gjp): ?>
                                                <?php $id++; ?>
                                                        ...
                                                        <div class="input-group">
                                                            <select name="gejala_input[]" class="form-control" required>
                                                                <?php foreach($gejala as $gj):?>
                                                                    <?php if($gj['id']==$gjp){
                                                                        echo '<option value="'.$gjp.'" selected>'.$gj['gejala'].'</option>';
                                                                    }?>
