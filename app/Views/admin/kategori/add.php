                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form class="form-horizontal form-label-left" action="<?php echo site_url('admin/kategori/add') ?>" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-9 col-sm-9 form-group has-feedback">
                                                    ...
                                                    type="text" placeholder="Nama Kategori" name="kategori" required>
