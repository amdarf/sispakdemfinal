                    ...
                    <div class="col-md-12 col-sm-12 ">
                        <div class="row">
                            <div class="col-md-12 ">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Form Tambah <small>Kategori</small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="tooltip-test" title="Kembali" href="<?php echo site_url('admin/kategori') ?>"><i class="fa fa-arrow-left"></i></a></li>
                                            <li><a class="collapse-link tooltip-test" title="Collapse"><i class="fa fa-chevron-up"></i></a></li>
                                            <li><a class="tooltip-test" title="Help" data-toggle="modal" data-target="#tambahkategoriHelp"><i class="fa fa-question"></i></a>
                                        </ul>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        <br />
                                        <form class="form-horizontal form-label-left" action="<?php echo site_url('admin/kategori/edit/'.$kategori['id']) ?>" method="POST" enctype="multipart/form-data">
                                            
                                            <div class="form-group row ">
                                                <label class="control-label col-md-3 col-sm-3 ">Nama Kategori* </label>
                                                <div class="col-md-9 col-sm-9 form-group has-feedback">
                                                    <input class="form-control <?php echo  $validation->getError('kategori') ? 'is-invalid':'' ?>"
                                                    type="text" placeholder="Nama Kategori" value="<?= $kategori['kategori'] ?>" name="kategori" required>
